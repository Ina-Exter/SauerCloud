...
if ! aws --profile "$SECGAME_USER_PROFILE" ec2 create-key-pair --key-name "AWS-secgame-mission2-keypair-Evilcorp-Evilkeypair-$SECGAME_USER_ID" --query 'KeyMaterial' --output text >> resources/ssh_key.pem
then
...
echo "[AWS-Secgame] Mission 2 deployment complete. Mission folder is ./mission2-$SECGAME_USER_ID. Read the briefing to begin, a copy can be found in the mission folder."
