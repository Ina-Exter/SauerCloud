...
if ! aws --profile "$SECGAME_USER_PROFILE" ec2 create-key-pair --key-name "AWS-secgame-mission3-keypair-Evilcorp-Evilkeypair-$SECGAME_USER_ID" --query 'KeyMaterial' --output text >> resources/ssh_key.pem
then
